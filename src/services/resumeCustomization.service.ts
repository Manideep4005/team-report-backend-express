import resumeCustomizationRepository
    from "../repositories/resumeCustomization.repository";
...
class ResumeCustomizationService {
    ...
    async createFromProfile(
        ...
        const existing =
            await resumeCustomizationRepository.findByUserId(
                userId
            );
        ...
        if (existing) {
            ...
            throw new ApiError(
                409,
                "Resume customization already exists."
            );
    ...
    async getCustomization(
        ...
        return resumeCustomizationRepository.findByUserId(
            userId
        );
